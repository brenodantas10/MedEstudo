...
$$FC = \dfrac{1}{T_{RR}(\pu{ms})}\times\dfrac{60.000(\pu{ms})}{1(\pu{min})}=\dfrac{}{}$$
...
> [!attention] Paciente Instável = Cardioversão Elétrica
...
### Conduta
> [!attention] Trombo se forma na aurícula
...
>[!attention] Flutter pode virar FA e vice-versa
