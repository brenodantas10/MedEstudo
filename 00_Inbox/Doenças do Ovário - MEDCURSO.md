...
- Avaliação Clínica e USG (deve ter 2 a 3 elementos)
	- **S**ólida
	- **U**SG Duppler com baixa resistência (IR < 0,4)
	- **S**EPTADA (espesso)
	- **P**apilas (especialmente > 4)
	- **E**spessamento da parede
	- **I**rregular
	- **T**amanho > 8 cm (ou 10 cm*)
	- **A**ntes ou **A**pós menacme / **A**scite
...
>[!attention] Pseudomixoma: Qualquer tumor mucinoso pode causar
...
> [!attention] Tumor de Krukenberg
> Não é primário de ovário, geralmente estômago (presença de células em anel de sinete)
...
> [!attention] Não são marcadores específicos
