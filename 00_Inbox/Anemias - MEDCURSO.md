...
- $\alpha_2\beta_2$: HbA (97%)
	- Anemia falciforme atua nessa
- $\alpha_2\delta_2$: HbA2 (2%) - Não é boa
- $\alpha_2\gamma_2$: HbF (1%) - Maior n fase fetal
...
- **Hemograma**
	...
	- **Se prolifera ou não**
		...
		- Corrigir pela anemia (Apenas se tiver alto)
			- $\text{Ht}/40\text{ ou Hb}/15 \times \text{Reticulocitos}$
	- Leuco: 5.000 - 11.000
...
> [!attention] Células com muita divisão sofrem mais
