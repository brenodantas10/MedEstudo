...
Usar SF 0,9% para pacientes menos graves
Usar Ringer para pacientes mais graves
...
Índice de Retenção
$$I_R = \dfrac{P_F-P_I}{V_R}$$
- $P_F$ -> Peso Final
- $P_I$ -> Peso Inicial
- $V_R$ -> Volume reconstituído
- $I_R$ -> Índice de retenção
