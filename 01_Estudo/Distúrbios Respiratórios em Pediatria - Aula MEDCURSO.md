...
- Diabetes materna
	...
	- Cortisol acelera maturação do pulmão fetal (estresse -> pode restringir crescimento)

### Clínica
- Taquipneia
- Sinais de desconforto

- Alveolo fechado -> pontos de atelecasia

#### Radiografia
- Reticulogranular difuso (aerobroncograma)
	- Aspecto em Vidro moído
- Volume diminuído

### Tratamento
- CPAP nasal -> Pressão positiva contínua pela via aérea
...
### Prevenção
- Corticoide antenatal -> Aumenta a criação do cortisol.
...
- Radiografia de tórax (igual a SDR)
...
## Taquipneia Transitória do RN
Tb conhecida como síndrome do pulmão úmido
### Mecanismo
