...
> [!Hint] Objetivo
> - $\uparrow\text{Na}$ em $8-10 \text{ mEq/L}$ em $24\text{h}$ (máximo)
> - $\uparrow\text{Na}$ em $4-6\text{ mEq/L}$ em $6\text{h}$ (agudo)
...
> Ocorre na Reposição rápida em pacientes crônicos (>48h)
> - Fatores de Risco
> 	- Etilismo
> 	- Desmutrição
> 	- Hipocalemia
...
> [!error] *Sodium Relowering*
> Caso a natremia suba acima do valor seguro
> - SG 5% 6ml/kg, IV em 2h
> - Desmopressina SC 2UI, IV ou SC, 6/6h
## Hipernatremia
